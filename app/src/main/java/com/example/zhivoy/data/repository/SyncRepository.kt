...
import com.example.zhivoy.network.dto.SyncBatchItemDto
...
class SyncRepository(
    ...
    private val db: com.example.zhivoy.data.AppDatabase,
) {
    ...
    suspend fun enqueue(userId: Long, entityType: String, action: String, payload: Map<String, Any>) {
        withContext(Dispatchers.IO) {
            db.syncQueueDao().insert(
                com.example.zhivoy.data.entities.SyncQueueEntity(
                    userId = userId,
