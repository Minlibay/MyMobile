package com.example.zhivoy.feature.main.training
...
fun AddTemplateDialog(
    onDismiss: () -> Unit,
    onAdd: (title: String, category: String, tags: String, duration: Int, calories: Int) -> Unit,
) {
    ...
    AlertDialog(
        ...
        confirmButton = {},
        title = { Text(text = "Новый шаблон", style = MaterialTheme.typography.titleLarge) },
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                OutlinedTextField(
                    ...
                    modifier = Modifier.fillMaxWidth(),
                    label = { Text("Категория (например, Силовая)") },
                    singleLine = true,
                    shape = RoundedCornerShape(16.dp),
                    colors = OutlinedTextFieldDefaults.colors(focusedBorderColor = MaterialTheme.colorScheme.primary),
                )
                ...
                ModernButton(
                    ...
                    onClick = {
                        ...
                        val c = caloriesText.toIntOrNull() ?: 0
                        if (t.isEmpty()) {
                            error = "Введите название"
                            return@ModernButton
                        }
                        onAdd(t, category.trim(), tags.trim(), d, c)
                    },
                )
