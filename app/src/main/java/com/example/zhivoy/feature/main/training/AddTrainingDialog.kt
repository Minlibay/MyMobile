...
fun AddTrainingDialog(
    onDismiss: () -> Unit,
    onAdd: (title: String, durationMinutes: Int, caloriesBurned: Int) -> Unit,
) {
    ...
    AlertDialog(
        ...
        confirmButton = {},
        title = { Text(text = "Добавить тренировку", style = MaterialTheme.typography.titleLarge) },
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                ModernButton(
                    ...
                    onClick = {
                        ...
                        if (t.isEmpty() || d <= 0) {
                            error = "Введите название и длительность"
                            return@ModernButton
                        }
                        onAdd(t, d, c.coerceAtLeast(0))
                    },
                )
