package com.volovod.alta.feature.main.brain
...
fun AddBookDialog(
    onDismiss: () -> Unit,
    onAdd: (title: String, author: String, totalPages: Int) -> Unit,
) {
    ...
    AlertDialog(
        ...
        confirmButton = {},
        title = { Text(text = "Добавить книгу", style = MaterialTheme.typography.titleLarge) },
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                ModernButton(
                    ...
                    onClick = {
                        ...
                        if (t.isEmpty() || p <= 0) {
                            error = "Введите название и количество страниц"
                            return@ModernButton
                        }
                        onAdd(t, author.trim(), p)
                    },
                )
