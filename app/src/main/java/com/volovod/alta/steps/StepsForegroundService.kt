package com.volovod.alta.steps
...
import com.volovod.alta.MainActivity
import com.volovod.alta.data.AppDatabase
import com.volovod.alta.data.repository.StepsRepository
...
class StepsForegroundService : Service() {
    companion object {
        ...
        private const val ACTION_START = "com.volovod.alta.steps.START"
        private const val ACTION_STOP = "com.volovod.alta.steps.STOP"
    ...
    private fun startTracking() {
        ...
        scope.launch {
            ...
            scope.launch {
                val today = com.volovod.alta.util.DateTime.epochDayNow()
    ...
    private fun buildNotification(contentText: String): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setSmallIcon(com.volovod.alta.R.mipmap.ic_launcher)
            .setContentTitle("Alta • Активность")
