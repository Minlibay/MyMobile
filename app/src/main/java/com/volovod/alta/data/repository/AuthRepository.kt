...
import com.volovod.alta.network.dto.ProfileRequestDto
import com.volovod.alta.network.dto.ProfileResponseDto
            ...
            try {
                ...
                if (localUserSettings != null) {
                    userSettingsApi.upsertUserSettings(UserSettingsRequestDto(
                        ...
                        target_weight_kg = localUserSettings.targetWeightKg,
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                if (refreshToken != null) {
                    authApi.logout(com.volovod.alta.network.dto.LogoutRequest(refresh_token = refreshToken))
                }
                sessionStore.clear()
                Result.success(Unit)
            } catch (_: Exception) {
