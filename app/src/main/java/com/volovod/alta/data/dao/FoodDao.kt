...
interface FoodDao {
    ...
    suspend fun getDailyCaloriesInRange(userId: Long, start: Int, end: Int): List<com.volovod.alta.data.model.DayValue>
    ...
    fun observeDailyCaloriesInRange(userId: Long, start: Int, end: Int): Flow<List<com.volovod.alta.data.model.DayValue>>
}
