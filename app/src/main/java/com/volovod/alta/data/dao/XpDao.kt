...
interface XpDao {
    ...
    suspend fun topUsersForRange(fromEpochDay: Int, limit: Int): List<com.volovod.alta.data.model.UserXpTotal>
    ...
    suspend fun getDailyXpInRange(userId: Long, start: Int, end: Int): List<com.volovod.alta.data.model.DayValue>
    ...
    fun observeDailyXpInRange(userId: Long, start: Int, end: Int): Flow<List<com.volovod.alta.data.model.DayValue>>
}
